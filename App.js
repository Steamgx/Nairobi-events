...
const dummyEvents = [
  {
    ...
    price: "Ksh 2,500",
    description:
      "Experience the best of African music with performances from Sauti Sol, Burna Boy and more!",
  },
  {
    id: "2",
    ...
    price: "Ksh 7,500",
    description:
      "East Africa's premier tech conference featuring speakers from Silicon Savannah",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    price: "Ksh 500",
    description:
      "Morning yoga session surrounded by nature with certified instructors",
  },
];
  ...
  const addToCalendar = async () => {
    try {
      ...
      if (status !== "granted") {
        Alert.alert(
          "Permission Denied",
          "Enable calendar access to add events."
        );
        return;
      }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        data={
          showSaved
            ? dummyEvents.filter((e) => savedEvents.includes(e.id))
            : filteredEvents
        }
      ...
      >
        <View style={styles.modalView}>
          ...
          <Text style={styles.modalText}>
            To book your ticket for{" "}
            <Text style={{ fontWeight: "bold" }}>{rsvpEventName}</Text>, send
            payment via M-Pesa to:
          </Text>
